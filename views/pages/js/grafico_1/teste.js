                    ...
                    if (agrup[json[k].site][m] !== undefined) {
                        for (let n = 0; n < tb.tHead.children.length; n++) {
                            ...
                            for (let v = 0; v < agrup[json[k].site][m].length; v++) {
                                ...
                                //console.log(Number.parseInt(tb.tHead.children[n].textContent[4] + tb.tHead.children[n].textContent[5]));
                                //console.log(data.getUTCDate());
                                // && (Number.parseInt(tb.tHead.children[n].value)) === data.getUTCMonth() + 1
                                if (n > 1) {
                                    if (Number.parseInt(tb.children[1].children[n].textContent[0] + tb.children[1].children[n].textContent[1]) === data.getUTCDate() && tb.children[1].children[n].value === (data.getUTCMonth() + 1)) {
                                        console.log(agrup[json[k].site][m][v].numero);
                                        //console.log(tb.children[1].children[n].value);
                                    } else {
                                        //console.log(tb.children[1].children[n].value + ":" + (data.getUTCMonth() + 1));
                                    }
                                }
                                if (n === 1) {
                                ...
                                } else if (Number.parseInt(tb.children[1].children[n].textContent[0] + tb.children[1].children[n].textContent[1]) === data.getUTCDate() && tb.children[1].children[n].value === (data.getUTCMonth() + 1)) {
                                    console.log("veio");
                                    if (td[m].textContent === "") {
                                        td[m].className = "tool";
